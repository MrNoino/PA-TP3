...
public class ManagerScreen extends JFrame implements ActionListener, ItemListener, ListSelectionListener {
    ...
    private JButton addUserButton, viewUsersSearchButton, updateUserButton;
